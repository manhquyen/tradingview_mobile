...
function createChannelString(symbolInfo, resolution) {
    ...
    // BTC_1m
    return symbolInfo.name.replace('/', '').toUpperCase() + "_" + resolution;
}
...
var UDFCompatibleDatafeedBase = /** @class */ (function () {
    function UDFCompatibleDatafeedBase(datafeedURL, datafeedSocket, quotesProvider, requester, updateFrequency) {
        var _this = this;
        if (updateFrequency === void 0) { updateFrequency = 10 * 1000; }
        this._configuration = defaultConfiguration();
        this._symbolsStorage = null;
        this._datafeedURL = datafeedURL;
        this._datafeedSocket = datafeedSocket;
        this._requester = requester;
        this._historyProvider = new HistoryProvider(datafeedURL, this._requester);
        this._quotesProvider = quotesProvider;
        this._dataPulseProvider = new DataPulseProvider(this._historyProvider, this._datafeedSocket, updateFrequency);
...
var UDFCompatibleDatafeed = /** @class */ (function (_super) {
    ...
    function UDFCompatibleDatafeed(datafeedURL, datafeedSocket, updateFrequency) {
        if (updateFrequency === void 0) { updateFrequency = 10 * 1000; }
        var _this = this;
        var requester = new Requester();
        var quotesProvider = new QuotesProvider(datafeedURL, requester);
        _this = _super.call(this, datafeedURL, datafeedSocket, quotesProvider, requester, updateFrequency) || this;
        return _this;
    }
