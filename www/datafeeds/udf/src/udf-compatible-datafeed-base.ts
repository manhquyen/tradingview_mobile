...
export class UDFCompatibleDatafeedBase implements IExternalDatafeed, IDatafeedQuotesApi, IDatafeedChartApi {
	...
	private readonly _datafeedSocket: string;
	...
	protected constructor(datafeedURL: string, datafeedSocket: string, quotesProvider: IQuotesProvider, requester: Requester, updateFrequency: number = 10 * 1000) {
